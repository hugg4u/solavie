...
*   **Guard/Permission:** `JwtAuthGuard`, `RequirePermissions('gateway.provider.read')`
...
*   **Guard/Permission:** `JwtAuthGuard`, `RequirePermissions('gateway.prompt.write')`
...
*   **Guard/Permission:** `JwtAuthGuard`, `RequirePermissions('gateway.prompt.read')`
